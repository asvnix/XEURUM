...
?>
    <section class="section section__banner section__banner--archive" style="background-image: url('<?= $image_url; ?>') !important;">
        <div class="container">
            <div class="row">
                <div class="wrapper">
    ...
    <section class="section__portfolio section__portfolio-page">
        <div class="container">
            <div class="row">
                <div class="wrapper">
                    <?php if (have_posts()): ?>
